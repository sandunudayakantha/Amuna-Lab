...
const PaymentForm = ({ amount, invoiceId, onSuccess, onFailure }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/payments/create-payment-intent`, {
        method: 'POST',
        headers: {
      ...
      if (result.error) {
        ...
        await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/payments/payment-failure`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/payments/payment-success`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
