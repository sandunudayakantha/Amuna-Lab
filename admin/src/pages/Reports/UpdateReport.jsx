...
const UpdateReport = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/testReports/${id}`, updatedData);
  ...
  return (
    <div className="p-6 bg-gray-100">
      ...
      <form onSubmit={handleUpdate} className="space-y-4">
        ...
        <button type="submit" className="mt-4 px-4 py-2 bg-blue-500 text-white rounded-2xl hover:bg-blue-600">
          Update Test Report
        </button>
      </form>
