...
const EditItem = () => {
  ...
  useEffect(() => {
    const fetchItem = async () => {
      try {
        ...
        const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/inventory/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/inventory/${id}`, dataToSend);
