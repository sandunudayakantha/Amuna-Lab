  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${import.meta.env.VITE_BACKEND_URL}/api/testTemplates/${id}`, // Correct URL
  ...
  return (
    <div className="p-6 bg-gray-100 rounded-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {test.inputType === "select" && (
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="mt-2 px-4 py-2 bg-blue-500 text-white rounded-3xl hover:bg-blue-600"
                  >
                    Add Option
                  </button>
                </div>
        ...
        <button
          type="submit"
          className="mt-6 px-4 py-2 bg-blue-500 text-white rounded-3xl hover:bg-blue-600"
        >
          Update Template
        </button>
      </form>
